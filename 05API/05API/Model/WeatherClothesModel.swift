...
class WeatherClothesModel {
    ...
    let imageList: [ImageMapping] = [
        ...
        ImageMapping(minTemp: -99, maxTemp: 4, image: UIImage(named: "four 1")!),
        ImageMapping(minTemp: -99, maxTemp: 4, image: UIImage(named: "four 2")!),
        ImageMapping(minTemp: 5, maxTemp: 8, image: UIImage(named: "five")!),
        ImageMapping(minTemp: 5, maxTemp: 8, image: UIImage(named: "five 1")!),
        ImageMapping(minTemp: 5, maxTemp: 8, image: UIImage(named: "five 2")!),
        ImageMapping(minTemp: 9, maxTemp: 11, image: UIImage(named: "nine")!),
        ImageMapping(minTemp: 9, maxTemp: 11, image: UIImage(named: "nine 1")!),
        ImageMapping(minTemp: 9, maxTemp: 11, image: UIImage(named: "nine 2")!),
        ImageMapping(minTemp: 12, maxTemp: 16, image: UIImage(named: "twelve")!),
        ImageMapping(minTemp: 12, maxTemp: 16, image: UIImage(named: "twelve 1")!),
        ImageMapping(minTemp: 12, maxTemp: 16, image: UIImage(named: "twelve 2")!),
        ImageMapping(minTemp: 17, maxTemp: 19, image: UIImage(named: "seventeen")!),
        ImageMapping(minTemp: 17, maxTemp: 19, image: UIImage(named: "seventeen 1")!),
        ImageMapping(minTemp: 17, maxTemp: 19, image: UIImage(named: "seventeen 2")!),
        ImageMapping(minTemp: 20, maxTemp: 22, image: UIImage(named: "twenty")!),
        ImageMapping(minTemp: 20, maxTemp: 22, image: UIImage(named: "twenty 1")!),
        ImageMapping(minTemp: 20, maxTemp: 22, image: UIImage(named: "twenty 2")!),
        ImageMapping(minTemp: 23, maxTemp: 27, image: UIImage(named: "twenty_three")!),
        ImageMapping(minTemp: 23, maxTemp: 27, image: UIImage(named: "twenty_three 1")!),
        ImageMapping(minTemp: 23, maxTemp: 27, image: UIImage(named: "twenty_three 2")!),
        ImageMapping(minTemp: 28, maxTemp: 99, image: UIImage(named: "twenty_eight")!),
        ImageMapping(minTemp: 28, maxTemp: 99, image: UIImage(named: "twenty_eight 1")!),
        ImageMapping(minTemp: 28, maxTemp: 99, image: UIImage(named: "twenty_eight 2")!),
